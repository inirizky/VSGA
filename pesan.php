    ...
    <header>
        <nav class="flex item-center justify-between p-6">
            ...
            <a href="/VSGA" class="cursor-pointer">Home</a>
                ...
                <a href="/VSGA/order-list.php" class="cursor-pointer">Daftar Pesanan</a>
            </div>
        </nav>
    </header>
...
<form class="w-full max-w-md">
  <div class="mb-5">
    <label for="email" class="block mb-2 w-full text-sm font-medium text-gray-900">Nama</label>
  ...
  <div class="mb-5">
    <label for="password" class="block mb-2 w-full text-sm font-medium text-gray-900">No Telp.</label>
  ...
  <div class="mb-5">
    <label for="repeat-password" class="block mb-2 w-full text-sm font-medium text-gray-900">Berapa orang?</label>
    <input type="password" id="repeat-password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
  </div>
  <div class="mb-5">
    <label for="repeat-password" class="block mb-2 w-full text-sm font-medium text-gray-900">Berapa orang?</label>
    <input type="password" id="repeat-password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
